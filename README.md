...
```
npm create cloudflare@latest -- --template=cloudflare/templates/misty-forest-59cf
```

## Preview Deployment

A live public deployment of this template is available at [https://misty-forest-59cf.templates.workers.dev](https://misty-forest-59cf.templates.workers.dev)
